...
SLUG_TO_FOLDER = {
    'intro-to-cybersecurity': '01. Intro to cybersecurity',
    'networking-fundamentals': '02. Networking Fundamentals',
    'operating-systems-security': '03. Operating system and security',
    'cryptography': '04. Cryptography',
    'web-application-security': '05. Web Application Security',
    'network-security': '06. Network Security',
    'security-assessment-testing': '07. Security Assessment and Testing',
    'incident-response-forensics': '08. Incident Response and Forensics',
